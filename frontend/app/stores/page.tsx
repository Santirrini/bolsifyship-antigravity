...
export default function StoreExplorerPage() {
    ...
    return (
        <div className="min-h-screen bg-gray-50/50 dark:bg-neutral-950 transition-colors duration-300 pb-20 md:pb-0">
            <Navbar />

            {/* Hero Section */}
            <div className="relative bg-white dark:bg-neutral-900 border-b border-gray-100 dark:border-neutral-800 pt-32 pb-16 overflow-hidden">
                {/* Background Decoration */}
                <div className="absolute inset-0 bg-[radial-gradient(#e5e7eb_1px,transparent_1px)] dark:bg-[radial-gradient(#171717_1px,transparent_1px)] [background-size:20px_20px] [mask-image:radial-gradient(ellipse_50%_50%_at_50%_50%,#000_70%,transparent_100%)] pointer-events-none opacity-70" />

                <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
                    <div className="inline-flex items-center gap-2 py-1.5 px-4 rounded-full bg-blue-50 dark:bg-blue-900/20 text-blue-600 dark:text-blue-400 text-xs font-bold tracking-wide uppercase mb-8 border border-blue-100 dark:border-blue-900/30 shadow-sm">
                    ...
                    <div className="max-w-2xl mx-auto relative group">
                        ...
                        <input
                            type="text"
                            className="block w-full pl-12 pr-4 py-4 bg-white dark:bg-neutral-800 border border-gray-200 dark:border-neutral-700 rounded-2xl text-gray-900 dark:text-white placeholder-gray-400 focus:outline-none focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 transition-all shadow-lg shadow-gray-200/50 dark:shadow-none"
                    ...
                    {CATEGORIES.map((category) => (
                        <button
                            ...
                            className={`px-6 py-2.5 rounded-full text-sm font-medium transition-all duration-300 border ${selectedCategory === category
                                ? 'bg-gray-900 dark:bg-white text-white dark:text-black border-transparent shadow-lg shadow-gray-900/20 dark:shadow-white/10 scale-105'
